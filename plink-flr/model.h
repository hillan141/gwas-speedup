...
class Model {
 ...
 public:
  ...
  virtual bool need_checkVIF() {return true;} // to be overloaded by implementation that do not need checkVIF.
 ...
 protected:
  ...
  private:
  void init_buildAdditive_cache();
  double build_additive_cache[32];
  bool build_additive_skip_cache[32];
